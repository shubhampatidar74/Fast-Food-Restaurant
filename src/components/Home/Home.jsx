    ...
    <>
      <div className="w-full h-screen">
        <div className="absolute z-[0] top-60 px-36">
          <h1 className=" font-DancingScript text-6xl text-white">
            Fast Food Restaurant
          </h1>
          <p className="mt-3 mb-4 w-6/12 text-white">
      ...
      <div className="w-full flex justify-around">
        <div className="w-1/3 rounded-lg p-2 bg-gray-800 flex justify-around items-center">
          <img
            className="w-52 bg-center border-4 border-yellow-500 rounded-full"
            src={asset01}
            alt=""
          />
          <div>
            <h1 className="text-white font-DancingScript text-2xl">
              Tasty Thursdays
            </h1>
            <br />
